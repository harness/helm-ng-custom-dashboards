...
![Version: 0.1.4](https://img.shields.io/badge/Version-0.1.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.52.19](https://img.shields.io/badge/AppVersion-v1.52.19-informational?style=flat-square)
...
| config.modelPrefix | string | `"QA_"` | if you have configured Looker models with a prefix enter it here |
